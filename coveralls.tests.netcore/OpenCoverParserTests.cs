...
namespace Coveralls.Tests
{
    ...
    public class OpenCoverParserTests
    {
        ...
        {
            var parser = new OpenCoverParser() { Report = TestHelpers.LoadResourceXml("coveralls.tests.netcore.Files.OpenCover.EmptyReport.xml") };
        ...
        {
            var parser = new OpenCoverParser() { Report = TestHelpers.LoadResourceXml("coveralls.tests.netcore.Files.OpenCover.SingleFileCoverage.xml") };
